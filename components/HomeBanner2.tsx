...
function HomeBanner2({}: Props) {
  return (
    ...
    <article className="flex items-start justify-center flex-col w-full sm:w-[50%] m-[10px] sm:m-[15px] p-[20px] text-white h-[50vh] bg-[url('/assets/banner/b17.jpg')] bg-no-repeat bg-center bg-cover ">
        ...
        <Link href="/shop" className='text-[1.1rem] py-[14px] px-[20px] border border-white font-semibold my-[5px] transition-all duration-500 text-white outline-none hover:bg-[#088178] hover:border-none'>Learn More</Link>
    </article>
