...
const HomeBanner1 = () => {
    return ( 
        ...
        <Link href="/" className="py-[10px] px-[20px] text-black bg-white mx-auto my-[5px] transition-all hover:bg-[#088178] hover:text-white rounded-md font-semibold duration-500">Explore More</Link>
        </section>
     );
}
